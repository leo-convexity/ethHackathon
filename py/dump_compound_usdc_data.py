...
print()
print('# Ethereum')
print(f'{"blockNumber":<32}    {blockNumber:>24,d}')
print()
...
#exchangeRateCalc = (getCash + totalBorrows - totalReserves) / totalSupply
...
print('# cUSDC')
print(f'{"exchangeRateCurrent":<32}    {exchangeRateCurrent:>24,.16f}')
#print(f'{"exchangeRateCalc":<32}    {exchangeRateCalc:>24,.16f}')
print(f'{"getCash":<32}    {getCash:>24,.6f}')
print(f'{"totalBorrows":<32}    {totalBorrows:>24,.6f}')
print(f'{"totalBorrowsCurrent":<32}    {totalBorrowsCurrent:>24,.6f}')
print(f'{"totalReserves":<32}    {totalReserves:>24,.6f}')
print(f'{"totalSupply":<32}    {totalSupply:>24,.8f}')
print(f'{"totalSupply*exchangeRateCurrent":<32}    {totalSupply*exchangeRateCurrent:>24,.6f}')
print(f'{"borrowRatePerBlock":<32}    {borrowRatePerBlock:>24,.18f}')
print(f'{"supplyRatePerBlock":<32}    {supplyRatePerBlock:>24,.18f}')
print()

f = lambda x, y: D(getattr(USDC.contract.functions, x)().call(block_identifier=blockNumber), y)
totalSupply = f('totalSupply', 6)
print('# USDC')
print(f'{"totalSupply":<32}    {totalSupply:>24,.6f}')
print()
