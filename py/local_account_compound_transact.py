...
parser = argparse.ArgumentParser(description='Mint or redeem from Compound.')
...
parser.add_argument('operation', metavar='OPERATION', nargs=None, type=str, help="operation - must be 'mint' or 'redeem'")
...
try:
    ...
    if args.operation.lower() == 'mint':
        side = -1
    elif args.operation.lower() == 'redeem':
        side = +1
    else:
