...
//Interface version of Compound contracts
...
interface CTokenStorage {
     ...
     */
    function admin() view external returns (address payable);

    /**
     * @notice Pending administrator for this contract
     */
    function pendingAdmin() view external returns (address payable);

    /**
     * @notice Contract which oversees inter-cToken operations
     */
    function comptroller() view external returns (ComptrollerInterface);

    /**
     * @notice Model which tells what the current interest rate should be
     */
    function interestRateModel() view external returns (InterestRateModel);

    /**
     * @notice Fraction of interest currently set aside for reserves
     */
    function reserveFactorMantissa() view external returns (uint);

    /**
     * @notice Block number that interest was last accrued at
     */
    function accrualBlockNumber() view external returns (uint);

    /**
     * @notice Accumulator of the total earned interest rate since the opening of the market
     */
    function borrowIndex() view external returns (uint);

    /**
     * @notice Total amount of outstanding borrows of the underlying in this market
     */
    function totalBorrows() view external returns (uint);

    /**
     * @notice Total amount of reserves of the underlying held in this market
     */
    function totalReserves() view external returns (uint);
...
interface CEth is CTokenInterface {}

interface CErc20 is CTokenInterface, CErc20Interface {}
